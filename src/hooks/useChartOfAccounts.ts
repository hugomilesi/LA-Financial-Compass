...
const defaultAccounts: Account[] = [
  ...
  // DESPESAS (EXPENSES) - NOVA ESTRUTURA HIERÁRQUICA
  ...
  // INVESTIMENTOS (ASSETS) - Mantidos da estrutura original
  {
    id: 'inv-1',
    code: '1.1',
  ...
  // RECEITAS NÃO OPERACIONAIS (REVENUE) - Mantidas da estrutura original
  {
    id: 'rev-2',
    code: '3.2',
